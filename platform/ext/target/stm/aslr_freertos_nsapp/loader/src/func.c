...
uint32_t func_info_size = 195;

func_info_t func_info[195] = {
    {0x8055945, 112, 0},  //MX_GPIO_Init
    {0x8055a1d, 252, 0},  //prvCreateTask
    {0x8055b19, 384, 0},  //prvAddNewTaskToReadyList
    {0x8056907, 318, 0},  //prvInitialiseNewTask
    {0x8056a45, 192, 0},  //prvInitialiseTaskLists
    {0x8055c99, 60, 0},  //prvResetNextTaskUnblockTime
    {0x8055cd5, 42, 0},  //prvDeleteTCB
    {0x8055d0f, 280, 0},  //prvAddCurrentTaskToDelayedList
    {0x8056203, 158, 0},  //prvCreateIdleTasks
    {0x8056b05, 56, 0},  //prvIdleTask
    {0x8056b3d, 124, 0},  //prvCheckTasksWaitingTermination
    {0x8056c31, 190, 0},  //prvCheckForValidListAndQueue
    {0x8056cef, 56, 0},  //prvTimerTask
    {0x8056d27, 64, 0},  //prvGetNextExpireTime
    {0x8056d67, 202, 0},  //prvProcessTimerOrBlockTask
    {0x8056e31, 478, 0},  //prvProcessReceivedCommands
    {0x805700f, 86, 0},  //prvSampleTimeNow
    {0x8057065, 110, 0},  //prvProcessExpiredTimer
    {0x8057175, 152, 0},  //prvInsertTimerInActiveList
    {0x805712f, 70, 0},  //prvReloadTimer
    {0x80570d3, 92, 0},  //prvSwitchTimerLists
    {0x8057507, 170, 0},  //prvHeapInit
    {0x80576c1, 292, 0},  //prvInsertBlockIntoFreeList
    {0x8057a95, 82, 0},  //prvInitialiseNewQueue
    {0x8057ae7, 240, 0},  //prvUnlockQueue
    {0x8057e83, 58, 0},  //prvIsQueueEmpty
    {0x8057e37, 76, 0},  //prvCopyDataFromQueue
    {0x8058251, 68, 0},  //prvTaskExitError
    ...
    {0x8058411, 22, 0},  //ulSetInterruptMask
    {0x8055731, 4, 0},  //I2C3_ER_IRQHandler
    {0x805576d, 4, 0},  //DFSDM1_FLT2_IRQHandler
    {0x80567bd, 36, 0},  //vTaskInternalSetTimeOutState
    ...
    {0x80583f1, 32, 0},  //vStartFirstTask
    {0x8058295, 304, 0},  //xPortStartScheduler
    {0x80584b1, 236, 0},  //memcpy
    {0x805653d, 78, 0},  //vTaskPlaceOnEventList
    {0x8057ff7, 70, 0},  //vPortSetupTimerInterrupt
    {0x8055601, 4, 0},  //EXTI0_IRQHandler
    {0x80556b9, 4, 0},  //I2C2_EV_IRQHandler
    {0x80575b1, 272, 0},  //vPortFree
    ...
    {0x8057813, 14, 0},  //vListInitialiseItem
    {0x8057bd7, 608, 0},  //xQueueReceive
    ...
    {0x805810d, 58, 0},  //vPortSVCHandler_C
    {0x805660f, 430, 0},  //xTaskRemoveFromEventList
    ...
    {0x80567e1, 224, 0},  //xTaskCheckForTimeOut
    ...
    {0x8055cff, 16, 0},  //vTaskSuspendAll
    {0x805788b, 72, 0},  //uxListRemove
    {0x805577d, 4, 0},  //OTFDEC1_IRQHandler
    {0x8055665, 4, 0},  //DMA1_Channel8_IRQHandler
    {0x805609b, 202, 0},  //vTaskSwitchContext
    {0x805658b, 132, 0},  //vTaskPlaceOnEventListRestricted
    ...
    {0x80568c1, 14, 0},  //vTaskMissedYield
    ...
    {0x8057ebd, 180, 0},  //vQueueAddToRegistry
    {0x80562a1, 648, 0},  //xTaskIncrementTick
    {0x8058427, 14, 0},  //vClearInterruptMask
    ...
    {0x80578d3, 284, 0},  //xQueueGenericReset
    {0x8055741, 4, 0},  //AES_IRQHandler
    {0x80558a1, 56, 0},  //testThread2
    {0x80559b5, 104, 0},  //xTaskCreate
    ...
    {0x80568cf, 56, 0},  //xTaskGetSchedulerState
    ...
    {0x8058147, 266, 0},  //pxPortInitialiseStack
    {0x8055759, 4, 0},  //SPI3_IRQHandler
    {0x8058675, 18, 0},  //trampoline_B_A
    {0x80556b5, 4, 0},  //I2C1_ER_IRQHandler
    {0x8055701, 4, 0},  //FMC_IRQHandler
    {0x8058055, 40, 0},  //vPortEnterCritical
...
uint32_t trampoline_A_B_addr=0x8058663;
uint32_t trampoline_B_A_addr=0x8058675;
