...
func_info_t func_info[203] = {
    {0x805596d, 112, 0},  //MX_GPIO_Init
    {0x8055c31, 194, 0},  //prvCreateTask
    {0x8055cf3, 384, 0},  //prvAddNewTaskToReadyList
    {0x8056ae1, 318, 0},  //prvInitialiseNewTask
    {0x8056c1f, 192, 0},  //prvInitialiseTaskLists
    {0x8055e73, 60, 0},  //prvResetNextTaskUnblockTime
    {0x8055eaf, 42, 0},  //prvDeleteTCB
    {0x8055ee9, 280, 0},  //prvAddCurrentTaskToDelayedList
    {0x80563dd, 158, 0},  //prvCreateIdleTasks
    {0x8056cdf, 56, 0},  //prvIdleTask
    {0x8056d17, 124, 0},  //prvCheckTasksWaitingTermination
    {0x8056e0b, 190, 0},  //prvCheckForValidListAndQueue
    {0x8056ec9, 56, 0},  //prvTimerTask
    {0x8056f01, 64, 0},  //prvGetNextExpireTime
    {0x8056f41, 202, 0},  //prvProcessTimerOrBlockTask
    {0x805700b, 478, 0},  //prvProcessReceivedCommands
    {0x80571e9, 86, 0},  //prvSampleTimeNow
    {0x805723f, 110, 0},  //prvProcessExpiredTimer
    {0x805734f, 152, 0},  //prvInsertTimerInActiveList
    {0x8057309, 70, 0},  //prvReloadTimer
    {0x80572ad, 92, 0},  //prvSwitchTimerLists
    {0x80576e1, 170, 0},  //prvHeapInit
    {0x805789b, 292, 0},  //prvInsertBlockIntoFreeList
    {0x8057c6f, 82, 0},  //prvInitialiseNewQueue
    {0x8057cc1, 240, 0},  //prvUnlockQueue
    {0x805805d, 58, 0},  //prvIsQueueEmpty
    {0x8058011, 76, 0},  //prvCopyDataFromQueue
    {0x8058431, 68, 0},  //prvTaskExitError
    ...
    {0x80585f1, 22, 0},  //ulSetInterruptMask
    {0x8055731, 4, 0},  //I2C3_ER_IRQHandler
    {0x805576d, 4, 0},  //DFSDM1_FLT2_IRQHandler
    {0x8056997, 36, 0},  //vTaskInternalSetTimeOutState
    {0x80559f7, 26, 0},  //Test
    ...
    {0x80585d1, 32, 0},  //vStartFirstTask
    {0x8058475, 304, 0},  //xPortStartScheduler
    {0x8058691, 236, 0},  //memcpy
    {0x8056717, 78, 0},  //vTaskPlaceOnEventList
    {0x80581d1, 70, 0},  //vPortSetupTimerInterrupt
    {0x8055601, 4, 0},  //EXTI0_IRQHandler
    {0x80556b9, 4, 0},  //I2C2_EV_IRQHandler
    {0x805778b, 272, 0},  //vPortFree
    ...
    {0x80582e7, 64, 0},  //vPortSVCHandler_C
    {0x80567e9, 430, 0},  //xTaskRemoveFromEventList
    ...
    {0x80569bb, 224, 0},  //xTaskCheckForTimeOut
    ...
    {0x8055ed9, 16, 0},  //vTaskSuspendAll
    {0x8057a65, 72, 0},  //uxListRemove
    {0x8055b9f, 42, 0},  //verify_benchmark
    {0x805577d, 4, 0},  //OTFDEC1_IRQHandler
    {0x8055665, 4, 0},  //DMA1_Channel8_IRQHandler
    {0x8056275, 202, 0},  //vTaskSwitchContext
    {0x8056765, 132, 0},  //vTaskPlaceOnEventListRestricted
    ...
    {0x8058217, 24, 0},  //vPortYield
    {0x80559dd, 26, 0},  //benchmark
    {0x80555d9, 4, 0},  //PVD_PVM_IRQHandler
    {0x80556c5, 4, 0},  //SPI2_IRQHandler
    {0x805877d, 164, 0},  //memset
    {0x80555c1, 4, 0},  //MemManage_Handler
    {0x8055901, 108, 0},  //main
    {0x8055639, 4, 0},  //EXTI14_IRQHandler
    {0x805562d, 4, 0},  //EXTI11_IRQHandler
    {0x80579fb, 106, 0},  //vListInsert
    {0x8058671, 32, 0},  //SVC_Handler
    {0x805571d, 4, 0},  //DMA2_Channel5_IRQHandler
    {0x80556fd, 4, 0},  //CRS_IRQHandler
    {0x8056d93, 120, 0},  //xTimerCreateTimerTask
    {0x8055659, 4, 0},  //DMA1_Channel5_IRQHandler
    {0x8055611, 4, 0},  //EXTI4_IRQHandler
    {0x8057bc9, 166, 0},  //xQueueGenericCreate
    {0x80551f5, 2, 0},  //SystemInit
    {0x8055745, 4, 0},  //RNG_IRQHandler
    {0x8055879, 40, 0},  //spin_100000
    {0x8055b79, 38, 0},  //initialise_benchmark
    {0x8056001, 628, 0},  //xTaskResumeAll
    {0x805633f, 158, 0},  //vTaskStartScheduler
    ...
    {0x8056a9b, 14, 0},  //vTaskMissedYield
    ...
    {0x8055a11, 204, 0},  //Sum
    {0x8058097, 180, 0},  //vQueueAddToRegistry
    {0x805647b, 648, 0},  //xTaskIncrementTick
    {0x8058607, 14, 0},  //vClearInterruptMask
    ...
    {0x8057aad, 284, 0},  //xQueueGenericReset
    {0x8055741, 4, 0},  //AES_IRQHandler
    {0x80558a1, 96, 0},  //testThread2
    {0x8055bc9, 104, 0},  //xTaskCreate
...
uint32_t trampoline_A_B_addr=0x8058843;
uint32_t trampoline_B_A_addr=0x8058855;
