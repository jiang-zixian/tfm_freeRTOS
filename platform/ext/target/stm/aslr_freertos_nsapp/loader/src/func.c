...
func_info_t func_info[200] = {
    ...
    {0x8055bf9, 192, 0},  //prvCreateTask
    {0x8055cb9, 384, 0},  //prvAddNewTaskToReadyList
    {0x8056ad5, 312, 0},  //prvInitialiseNewTask
    {0x8056c0d, 184, 0},  //prvInitialiseTaskLists
    {0x8055e39, 60, 0},  //prvResetNextTaskUnblockTime
    {0x8055e75, 48, 0},  //prvDeleteTCB
    {0x8055eb5, 284, 0},  //prvAddCurrentTaskToDelayedList
    {0x80563a9, 172, 0},  //prvCreateIdleTasks
    {0x8056cc5, 56, 0},  //prvIdleTask
    {0x8056cfd, 124, 0},  //prvCheckTasksWaitingTermination
    {0x8056ea9, 52, 0},  //prvTimerTask
    {0x8056df5, 180, 0},  //prvCheckForValidListAndQueue
    {0x8056edd, 64, 0},  //prvGetNextExpireTime
    {0x8056f1d, 184, 0},  //prvProcessTimerOrBlockTask
    {0x8056fd5, 444, 0},  //prvProcessReceivedCommands
    {0x8057191, 92, 0},  //prvSampleTimeNow
    {0x80571ed, 108, 0},  //prvProcessExpiredTimer
    {0x805730d, 160, 0},  //prvInsertTimerInActiveList
    {0x80572c1, 76, 0},  //prvReloadTimer
    {0x8057259, 104, 0},  //prvSwitchTimerLists
    {0x8057691, 170, 0},  //prvHeapInit
    {0x8057845, 304, 0},  //prvInsertBlockIntoFreeList
    {0x8057c1d, 92, 0},  //prvInitialiseNewQueue
    {0x8057c79, 224, 0},  //prvUnlockQueue
    {0x8057fb9, 64, 0},  //prvIsQueueEmpty
    {0x8057f61, 88, 0},  //prvCopyDataFromQueue
    {0x80583c5, 76, 0},  //prvTaskExitError
    ...
    {0x80585a5, 22, 0},  //ulSetInterruptMask
    {0x8055731, 4, 0},  //I2C3_ER_IRQHandler
    {0x805576d, 4, 0},  //DFSDM1_FLT2_IRQHandler
    {0x805698d, 36, 0},  //vTaskInternalSetTimeOutState
    {0x80559c5, 36, 0},  //Test
    ...
    {0x8058581, 36, 0},  //vStartFirstTask
    {0x8058411, 296, 0},  //xPortStartScheduler
    {0x8058655, 236, 0},  //memcpy
    {0x80566f9, 80, 0},  //vTaskPlaceOnEventList
    {0x805813d, 70, 0},  //vPortSetupTimerInterrupt
    {0x8055601, 4, 0},  //EXTI0_IRQHandler
    {0x80556b9, 4, 0},  //I2C2_EV_IRQHandler
    {0x805773d, 264, 0},  //vPortFree
    ...
    {0x805826d, 76, 0},  //vPortSVCHandler_C
    {0x80567d5, 440, 0},  //xTaskRemoveFromEventList
    ...
    {0x80569b1, 220, 0},  //xTaskCheckForTimeOut
    ...
    {0x8055ea5, 16, 0},  //vTaskSuspendAll
    {0x8057a1b, 72, 0},  //uxListRemove
    {0x805577d, 4, 0},  //OTFDEC1_IRQHandler
    {0x8055665, 4, 0},  //DMA1_Channel8_IRQHandler
    {0x805623d, 212, 0},  //vTaskSwitchContext
    {0x8056749, 140, 0},  //vTaskPlaceOnEventListRestricted
    ...
    {0x8056a8d, 14, 0},  //vTaskMissedYield
    ...
    {0x80559e9, 204, 0},  //Sum
    {0x8057ff9, 192, 0},  //vQueueAddToRegistry
    {0x8056455, 656, 0},  //xTaskIncrementTick
    {0x80585bb, 14, 0},  //vClearInterruptMask
    ...
    {0x8057a65, 268, 0},  //xQueueGenericReset
    {0x8055741, 4, 0},  //AES_IRQHandler
    {0x8055891, 72, 0},  //testThread2
    {0x8055b89, 112, 0},  //xTaskCreate
